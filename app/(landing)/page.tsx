      ...
      <div className="border-l border-r max-w-4xl w-full mx-auto border-dashed h-full flex justify-center flex-col border-gray-300">
        <div className="justify-center items-center h-full flex flex-col my-10">
          <div className="border-t border-dashed border-gray-300 w-full mx-auto py-10 flex justify-center items-center relative">
            <Plus className="text-purple-400 group-hover:text-purple-400 w-7 h-7 absolute top-0 -translate-x-1/2 -translate-y-1/2 left-0" />
            <Image
          ...
          <div className="relative group">
            <h1 className="font-semibold text-3xl md:text-7xl text-center w-full border-t border-b py-6 border-dashed text-balance px-4 text-black border-gray-300">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-br from-purple-500 to-blue-400">
                Invoice Maker
              </span>
            </h1>
          </div>
          <div className="pt-10 pb-11 flex gap-3 items-center mx-auto border-gray-300 border-b w-full justify-center border-dashed relative">
            <Plus className="text-purple-400 group-hover:text-purple-400 w-7 h-7 absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2" />
            <Link
              href="/new"
              className="inline-flex items-center justify-center whitespace-nowrap rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring font-medium disabled:pointer-events-none disabled:opacity-50 bg-gradient-to-br from-purple-500 to-blue-400 text-white hover:bg-black/90 px-6 py-2 text-lg"
            >
              Create Invoice
            </Link>
            <a
        ...
        <p className="font-medium text-xl md:text-3xl border-t border-gray-300 border-b border-dashed md:py-6 py-3 px-7 text-neutral-700 text-center">
          Here&apos;s why you&apos;ll love our Free Invoice Maker
        </p>
        <div className="grid sm:grid-cols-2 relative">
          <Plus className="text-purple-600 group-hover:text-purple-600 w-7 h-7 absolute top-0 -translate-x-1/2 -translate-y-1/2 left-0" />
          <Plus className="text-purple-600 group-hover:text-purple-600 w-7 h-7 absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2" />
          <div className="border-r border-b border-dashed p-7 border-gray-300 flex justify-center flex-col items-center">
            <p className="border flex justify-center items-center w-11 h-11 border-dashed rounded-lg text-2xl mb-5 border-gray-300 bg-gradient-to-br from-purple-100 to-blue-100">
              <ZapIcon />
            </p>
            <p className="font-bold text-xl">Quick & Effortless</p>
            <p className="text-neutral-500 mt-1 text-center">
            Simply input the information and generate polished invoices quickly.
            </p>
          </div>
          ...
          <div className="border-r border-b border-dashed flex justify-center flex-col items-center p-7 border-gray-300">
            ...
            <p className="font-bold text-xl">Elegant Templates</p>
            <p className="text-neutral-500 mt-1 text-center">
            Select from a range of sleek and customizable invoice templates.
            </p>
          </div>
          <div className="border-b border-gray-300 border-dashed flex justify-center flex-col items-center p-7">
            ...
            <p className="font-bold text-xl">Get Paid Swiftly</p>
            <p className="text-neutral-500 mt-1 text-center">
            Issue invoices electronically with safe payment links for expedited payments.
            </p>
          </div>
          <div className="border-r border-gray-300 border-b border-dashed flex justify-center flex-col items-center p-7">
            ...
            <p className="font-bold text-xl">Cut Time & Costs</p>
            <p className="text-neutral-500 mt-1 text-center">
            Say goodbye to spreadsheets and costly invoicing tools.
            </p>
          </div>
          <div className="border-b border-dashed p-7 border-gray-300 flex justify-center flex-col items-center">
            ...
            <p className="text-neutral-500 mt-1 text-center">
            Completely free, with full customization to suit your needs.
            </p>
          </div>
        </div>
        <div className="px-5 py-11 flex justify-center items-center border-b border-dashed border-gray-300">
          <div className="flex justify-center rounded-2xl max-w-3xl border-dashed items-center px-4 py-10 w-full flex-col gap-4  bg-gradient-to-br from-purple-100 to-blue-100">
        ...
        <div className="flex justify-center items-center border-b border-dashed mb-20 border-gray-300 py-10 px-4 gap-4">
          ...
          <div className="border flex justify-center items-center w-10 h-10 border-dashed rounded-lg text-2xl border-gray-300">
            <a target="_blank" href="https://www.linkedin.com/in/aditya-gup1a/">
              <Linkedin />
            </a>
          </div>
