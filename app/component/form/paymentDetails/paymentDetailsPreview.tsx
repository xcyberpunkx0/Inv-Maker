...
> = ({
  ...
  return (
    ...
    >
      {!!onClick && (
        <>
          <ChevronDown className="animate-pulse w-5 h-5 text-purple-500 rotate-[135deg] group-hover:block hidden absolute top-0 left-0" />
          <ChevronDown className="animate-pulse w-5 h-5 text-purple-500 -rotate-[135deg] group-hover:block hidden absolute top-0 right-0" />
          <ChevronDown className="animate-pulse w-5 h-5 text-purple-500 rotate-45 group-hover:block hidden absolute bottom-0 left-0" />
          <ChevronDown className="animate-pulse w-5 h-5 text-purple-500 -rotate-45 group-hover:block hidden absolute bottom-0 right-0 " />
        </>
      )}
